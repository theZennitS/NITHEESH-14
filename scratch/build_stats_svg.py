...
<style>{font_css}
  text.lbl {{ fill:#7d8590; font-size:9px; font-weight:600; font-family:'Minecraft', -apple-system, sans-serif !important; transform-box: fill-box; transform-origin: center; transform: scaleY(1.15); }}
  text.total {{ fill:#e6edf3; font-size:11px; font-weight:bold; font-family:'Minecraft', -apple-system, sans-serif !important; transform-box: fill-box; transform-origin: left bottom; transform: scaleY(1.2); }}
